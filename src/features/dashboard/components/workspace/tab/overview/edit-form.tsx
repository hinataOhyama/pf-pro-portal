...
import { colors } from "@/lib/get-random-workspace-color";
import { Warning } from "@/components/ui/warning";

type OverviewEditFormProps = {
  workspace: SettingsWorkspace;
}

export const OverviewEditForm = ({ workspace: { id, color, name } }: OverviewEditFormProps) => {
  ...
  return (
    <Form {...form}>
      ...
      >
                      ...
                      {colors.map((color) => (
                        ...
                        >
                          <FormControl>
                            <RadioGroupItem
                              value={color}
                              //@ts-expect-error Ignoring type error for useCheckIcon due to specific library behavior
                              useCheckIcon
        ...
        >
          {isPending ? <Loading text={t("BTN_PENDING")} /> : t("BTN")}
        </Button>
      </form>
    </Form>
  );
