...
import { useUserEditableWorkspaces } from "@/features/dashboard/context/editable-workspaces";
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
...
type TaskShortcutProps = {
  userId: string;
};

export const TaskShortcut = ({ userId }: TaskShortcutProps) => {
                ...
                <div className="flex flex-col w-full my-4 gap-6">
                  {currentTab === "main" ? (
                    <MainTab
                      ...
                      onChangeTitleAction={changeTitleHandler}
                      onSelectedDateAction={selectedDateHandler}
                      onChangeTabAction={changeTabHandler}
                      onSelectEmojiAction={selectEmojiHandler}
                    />
                  ) : (
                    <Workspaces
