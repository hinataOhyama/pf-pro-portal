...
import { useOnboardingForm } from "@/features/onboarding/context/form";
import {
  additionalUserSecondStep,
  AdditionalUserSecondStep,
} from "@/features/onboarding/schema/additional-user";
import { ActionType } from "@/features/onboarding/types/context";
...
export const SecondStep = () => {
  ...
  const form = useForm<AdditionalUserSecondStep>({
    resolver: zodResolver(additionalUserSecondStep),
  });
  const t = useTranslations("ONBOARDING_FORM");

  const onSubmit = (data: AdditionalUserSecondStep) => {
