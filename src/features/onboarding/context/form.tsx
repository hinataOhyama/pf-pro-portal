...
} from "@/features/onboarding/types/context";
...
type OnboardingFormProviderProps = {
...
export const OnboardingFormProvider = ({ children, session }: OnboardingFormProviderProps) => {
